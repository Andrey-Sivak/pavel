...
if ( $shortcode && $modal_id ) :
	...
	>
		<div
			class="pm-modal__inner w-full bg-[#003459] md:max-w-[750px] max-w-[90%] relative xl:rounded-[60px] md:rounded-[40px] rounded-[20px] lg:py-10 md:py-10 py-7.5 md:px-10.5 px-2 transition-all duration-500 pm-form-wrap">
			<div
				class="pm-modal__close absolute z-30 block cursor-pointer xl:top-15 md:top-10 top-5 xl:right-15 md:right-10 right-5 md:w-auto w-4 left-auto"
				title="<?php echo esc_attr__( 'Close', 'pm' ); ?>"
			>
				<svg class="block max-w-full" width="20" height="20" viewBox="0 0 24 24" fill="none"
					 aria-hidden="true">
					<path
			...
			<div class="max-h-[calc(100vh_-_100px)] overflow-y-auto px-2 pm-modal__inner-wrap relative z-20">
