...
$profileImage    = $attributes['profileImage'] ?? array(
	'id'  => null,
	'url' => '',
);
$socialLinks     = $attributes['socialLinks'] ?? array();
$primaryButton   = $attributes['primaryButton'] ?? array(
	'text'   => '',
	'url'    => '',
	'target' => '',
);
$secondaryButton = $attributes['secondaryButton'] ?? array(
	'text'   => '',
	'url'    => '',
	'target' => '',
);
						...
						<?php foreach ( $socialLinks as $socialLink ) : ?>
							...
							>
								...
								if ( ! empty( $socialLink['icon']['id'] ) ) {
									echo wp_get_attachment_image( $socialLink['icon']['id'], 'full', false, array() );
								}
								?>
							</a>
						<?php endforeach; ?>
